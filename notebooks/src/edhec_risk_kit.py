...
def summary_stats_terminal(
    ...
    # terminal wealths mean
    # terminal wealths volatility
    # probability of breaching the floor
    ...
    stats = pd.DataFrame.from_dict(
        {
            ...
            "Mean wealth": terminal_wlt.mean(),
            "Mean wealth std": terminal_wlt.std(),
            "Prob breach": floor_breach.mean() if floor_breach.sum() > 0 else 0,
